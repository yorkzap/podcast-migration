					...
					<?php if ( ( 'off' !== $show_default_title && $is_page_builder_used ) || ! $is_page_builder_used ) { ?>
						...
						<div class="podcast-banner">
							...
							<div class="podcast-content">
								...
								<a href="LINK_TO_YOUR_EPISODE" class="podcast-listen-button">Listen Now</a>
							</div>
                        ...
                        <?php 
                            ...
                            if ($iframe_link): ?>
                                <div id="player" class="podcast-player-container">
                                    <?php echo $iframe_link; ?>
                                </div>
                        <?php endif; ?>

                           <!-- Insert the podcast section HTML here -->
                           <div class="cover-section">
                            <div class="text-overlay">
                                <h1 class="podcast-title">MASTER THE SALES GAME PODCAST</h1>
                                <div class="host-name-wrapper">
                                    <span class="with-text">with</span>
                                    <p class="name-text">Susan McVea</p>
                                </div>
                            </div>
                            <div class="image-container">
                                <img class="cover-image" src="https://staging17.podcast.susanmcvea.com/wp-content/uploads/2023/12/Susan-Podcast-Master-The-Sales-Game.png" alt="Susan McVea">
                            </div>
                        </div>


						<!-- Podcast Banner ends here -->
